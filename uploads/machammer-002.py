...
def hammertime():
    print 'Make sure your Guardian is in the OPEN position'
    ...
    #print guardip
    UDP_IP = guardip
    MESSAGE1 = '{"command":"motor_calibration", "action":"close","type":0}'
    MESSAGE2 = '{"command":"motor_calibration", "action":"open","type":0}'
